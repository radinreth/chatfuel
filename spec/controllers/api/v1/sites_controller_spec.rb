  ...
  describe "PATCH :update" do
    ...
    let(:params) {
      { site_code: site.code, tickets: [
        { TicketID: '0102-001', Tell: '011 222 333', DistGis: '0102', ServiceDescription: 'សំបុត្តកំណើត', Status: 'Approved', RequestedDate: 1.day.ago,  ApprovalDate: Date.today, DeliveryDate: ''}
      ]}
    }
